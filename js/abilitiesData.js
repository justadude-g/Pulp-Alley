...
// chapter (Epic abilities). League Perks and Gang-only abilities are not
// included here since they aren't per-character card fields.
//
...
export const ABILITIES = [
  ...
  { name: 'Animal', level: 1, text: 'Add +1 die to two skills. Reduce Shoot to no-dice.' },
  { name: 'Aquatic', level: 1, text: 'You automatically pass the perils for difficult and perilous areas in deep water. In the deep, your line-of-sight is up to 12” and you ignore the –1 fight penalties.' },
  { name: 'Armored', level: 1, text: 'You cannot move over 6” except to rush. You roll one bonus die for all Health checks.' },
  { name: 'Beast', level: 1, text: 'You cannot perform actions. Select two of the following abilities at no cost: Animal, Aquatic, Big, Fierce, Mindless, Reanimated, Speedy, Swarm, Winged.' },
  { name: 'Brainy', level: 1, text: 'Add +1 die to Dodge and Cunning. Reduce Brawl to no-dice.' },
  { name: 'Brute', level: 1, text: 'Once per turn, you may re-roll one Brawl or Might die.' },
  ...
  { name: 'Crafty', level: 1, text: 'Once per turn, you may re-roll one Dodge or Cunning die.' },
  { name: 'Fierce', level: 1, text: 'Add +1 die to Brawl.' },
  { name: 'Goon', level: 1, text: 'You cannot perform actions. Select two of the following abilities at no cost: Aquatic, Brute, Fierce, Marksman, Sharp, Slam, Trick, Winged.' },
  { name: 'Hard-Nosed', level: 1, text: 'Once per turn, you may re-roll one Might, Finesse, or Cunning die.' },
  { name: 'Marksman', level: 1, text: 'Add +1 die to Shoot.' },
  { name: 'Mighty', level: 1, text: 'Add +1 die to Might.' },
  { name: 'Mindless', level: 1, text: 'Raise Brawl and Might one dice-type. Reduce Cunning and Finesse one dice-type. Note, if a d6 skill is reduced then it drops to no-dice.' },
  ...
  { name: 'Reanimated', level: 1, text: 'You automatically pass all 1d Health checks. Reduce Dodge to no-dice. You cannot block. You cannot move over 6” except to rush.' },
  { name: 'Savvy', level: 1, text: 'Add +1 die to Finesse.' },
  { name: 'Shadowy', level: 1, text: 'You gain a +1 bonus to all opposed spotting checks.' },
  { name: 'Sharp', level: 1, text: 'Once per turn, you may re-roll one Shoot or Finesse die.' },
  { name: 'Short Burst', level: 1, text: 'Action: Place the Short Burst (see Burst rules).' },
  { name: 'Slam', level: 1, text: 'Once per turn, you may discard to gain a +1 bonus to Brawl or Might.' },
  { name: 'Sly', level: 1, text: 'Add +1 die to Dodge and Finesse. Reduce Brawl to no-dice.' },
  { name: 'Speedy', level: 1, text: 'You may move up to 16” — instead of 12”.' },
  { name: 'Swarm', level: 1, text: 'You may play a peril from your Fortune hand on an enemy when they come into contact or activate in contact with you.' },
  { name: 'Trick', level: 1, text: 'Once per turn, you may discard to gain a +1 bonus to Shoot or Finesse.' },
  { name: 'True Believer', level: 1, text: '(Followers, Allies, and Sidekicks only) Reduce Shoot to no-dice. When rolling for any other skill, you roll a number of dice equal to your character level. You ignore all modifiers except Fortune card effects. You can never have any other abilities.' },
  { name: 'Two-Fisted', level: 1, text: 'Add +1 die to two skills. Reduce Shoot to no-dice.' },
  { name: 'Winged', level: 1, text: 'You may fly up to 16” and ignore the intervening terrain and characters. You cannot fly shoot during the same activation when you are at ground level.' },

  // ---- Level 2 ----
  { name: 'Big', level: 2, text: 'Raise Health and Might one dice-type. Reduce Dodge and Finesse one dice-type. Note, if a d6 skill is reduced then it drops to no-dice.' },
  ...
  { name: 'Eagle-Eyed', level: 2, text: 'Your close range goes up to 12", and long range is over 48".' },
  ...
  { name: 'Relentless', level: 2, text: 'Once per turn, when you knock an enemy down or out during a brawl, you may immediately move up to 3” towards the closest enemy. Do not resolve another fight during this activation.' },
  ...
  { name: 'Unearthly', level: 2, text: 'When an enemy fights you, they must substitute their Brawl and Shooting dice with their Cunning or Finesse dice (their choice). Otherwise, the fight is resolved as normal. You cannot shoot over 12”. You cannot move over 6” except to rush.' },
...
export function findAbilityByName(name) {
  ...
  if (!n) return null;
  return ABILITIES.find(a => a.name.toLowerCase() === n) || null;
}

// Substring search across ability names, ranked so names that start with
// the query come first. Capped to `limit` results.
export function searchAbilities(query, limit = 8) {
